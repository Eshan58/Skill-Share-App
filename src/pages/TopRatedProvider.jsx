  ...
  return (
    <div className="top-providers-section py-16 bg-gradient-to-br from-blue-50 to-purple-50">
      <div className="container mx-auto px-4">
        ...
        <div className="social-section text-center pt-8 border-t border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">Follow Us</h3>
          <div className="flex justify-center items-center gap-6">
            <a
              href="#"
              className="social-link flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-all duration-200 transform hover:-translate-y-1"
            >
            ...
            <a
              href="#"
              className="social-link flex items-center gap-2 bg-pink-600 text-white px-6 py-3 rounded-lg hover:bg-pink-700 transition-all duration-200 transform hover:-translate-y-1"
            >
            ...
            <a
              href="#"
              className="social-link flex items-center gap-2 bg-blue-400 text-white px-6 py-3 rounded-lg hover:bg-blue-500 transition-all duration-200 transform hover:-translate-y-1"
            >
